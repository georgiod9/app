...
export default function Home() {
  ...
  async function searchContract(e: React.ChangeEvent<HTMLTextAreaElement>) {
    ...
    if (token.length > 0 && (token.length < 32 || token.length > 44)) {
        ...
        <>
          <span className="flex justify-center items-center">
            <div className="relative">
              {QModalTokenOpen3 && (
                <QModal text="Minimum funding is 0.1 SOL/Wallet/Day." w={155} />
              )}
              <svg
                ...
                viewBox="0 0 20 20"
                fill="#FFFFFF80"
                className="pl-0.5 md:pl-1 w-[15px] h-[15px] md:w-[18px] md:h-[18px] opacity-50 hover:opacity-100 pt-0.5"
              >
                <path
                  fillRule="evenodd"
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content={WebsiteName + " | " + WebsiteSlogan}
        />
      ...
      <div className="block justify-center md:mt-0 md:max-w-xl lg:max-w-6xl md:mx-auto mx-2.5">
        <div id="hero" className="mt-20 md:mt-28">
          <h1 className="text-lg md:text-2xl lg:text-4xl md:text-center text-start font-[400]">
            Our Bots keep your token Bumping on Pump Dot Fun.
          </h1>
        </div>
        <div
          id="insights"
          className="md:flex md:justify-center md:mx-auto my-5 md:my-8"
        >
          <Insight />
        </div>
      </div>
        ...
        <div className="flex justify-center mx-auto w-full">
          <div id="bump-form" className="bg-[#2E303A] rounded-md w-full mb-10">
            <div className="lg:mx-7 md:mx-4 mx-2.5">
              ...
              <div
                id="bump-settings"
                className="lg:flex lg:flex-row lg:row-span-2 lg:gap-x-8"
              >
                <div id="package-selector" className="lg:w-1/2 w-full">
                  <div
                    id="package-1"
                    onClick={() => setBumpPackage(1)}
                    className={`w-full select-none rounded-md px-3 py-2.5 ${
                      bumpPackage == 1
                        ? "bg-green text-[#000]"
                        : "bg-[#FFFFFF1A] hover:bg-[#FFFFFF1A]/15 text-white"
                    }`}
                  >
                    <div className="flex flex-row row-span-3">
                          ...
                          <>
                            <div className="mt-1 w-6 h-6 border rounded-full bg-white border-white text-green flex">
                              <svg
                                ...
                                viewBox="0 0 20 20"
                                fill="currentColor"
                                className="w-5 h-5 flex justify-center items-center m-auto"
                              >
                                <path
                                  fillRule="evenodd"
                      ...
                      <div className="w-[85%] sm:w-[67.5%]">
                        ...
                        <span className="sm:hidden py-0.5 font-[500] text-md">
                          0.05 Sol
                          <span className="opacity-50 text-sm font-[400] pl-1">
                            /day
                          </span>
                        </span>
                        <p className="font-[400] text-sm opacity-50 py-1.5 sm:py-0 sm:pt-2 sm:pb-1.5">
                          3 Wallet Bumping the Token
                        </p>
                        <p className="font-[400] text-sm opacity-50">
                          1 Bump per Minute
                        </p>
                      </div>
                      <div className="hidden sm:block sm:w-[25%]">
                        <span className="flex items-center justify-end py-0.5 font-[500] text-md">
                          0.05 Sol
                          <span className="opacity-50 text-sm font-[400] pl-1">
                            /day
                          </span>
                  ...
                  <div
                    id="package-2"
                    onClick={() => setBumpPackage(2)}
                    className={`my-3 w-full select-none rounded-md px-3 py-2.5 ${
                      bumpPackage == 2
                        ? "bg-green text-[#000]"
                        : "bg-[#FFFFFF1A] hover:bg-[#FFFFFF1A]/15 text-white"
                    }`}
                  >
                    <div className="flex flex-row row-span-3">
                      ...
                      <div className="w-[85%] sm:w-[67.5%]">
                        ...
                        <p className="font-[400] text-sm opacity-50 py-1.5 sm:py-0 sm:pt-2 sm:pb-1.5">
                          10 Wallet Bumping the Token
                        </p>
                        <p className="font-[400] text-sm opacity-50">
                          1 Bump per 30 Seconds
                        </p>
                      </div>
                      <div className="hidden sm:block sm:w-[25%]">
                        <span className="flex items-center justify-end py-0.5 font-[500] text-md">
                  ...
                  <div
                    id="package-3"
                    onClick={() => setBumpPackage(3)}
                    className={`w-full rounded-md select-none px-3 py-2.5 ${
                      bumpPackage == 3
                        ? "bg-green text-[#000]"
                        : "bg-[#FFFFFF1A] hover:bg-[#FFFFFF1A]/15 text-white"
                    }`}
                  >
                    <div className="flex flex-row row-span-3">
                      ...
                      <div className="w-[85%] sm:w-[67.5%]">
                        ...
                        <p className="font-[400] text-sm opacity-50 py-1.5 sm:py-0 sm:pt-2 sm:pb-1.5">
                          25 Wallet Bumping the Token
                        </p>
                        <p className="font-[400] text-sm opacity-50">
                          1 Bump per 10 Seconds
                        </p>
                      </div>
                      <div className="hidden sm:block sm:w-[25%]">
                        <span className="flex items-center justify-end py-0.5 font-[500] text-md">
                ...
                <div id="bump-details" className="lg:w-1/2 w-full">
                    ...
                    {!tokenFound ? (
                      <>
                        <div className="mt-3 lg:mt-0 w-full rounded-md px-3 py-2.5 bg-[#FFFFFF1A] text-white">
                          <div
                            id="label"
                            className="sm:flex sm:flex-row sm:row-span-2 sm:items-center"
                          >
                            <div className="flex font-[400] sm:w-[35%]">
                              <span className="text-[#FFFFFF80] text-xs md:text-sm">
                                Token address
                              </span>
                              <span className="text-[#FFFFFF80] text-[10px] ml-0.5">
                                *
                              </span>
                              <div className="relative">
                                {QModalTokenOpen0 && (
                                  <QModal
                                    text="The token address you want to pump."
                                    w={140}
                                  />
                                )}
                                <svg
                            ...
                            <div
                              id="token-input"
                              className="flex justify-start sm:w-[65%] sm:mt-0 mt-1.5"
                            >
                              <div className="relative w-full">
                                <textarea
                                  ...
                                  placeholder="Address"
                                  className={`w-full h-full flex text-sm rounded-md px-3 py-2 sm:py-2.5 focus:outline-none ${
                                    tokenError
                                      ? "focus:border-red"
                                      : "focus:outline-none focus:border-green"
                                  } border border-white bg-bg/50`}
                                  style={{ resize: "none" }}
                                />
                                {tokenSearching && (
                                  <>
                          ...
                          {tokenError && (
                            <p className="text-[8px] text-start sm:text-end text-red pt-2 p-1">
                              {tokenError}
                            </p>
                          )}
                        </div>
                        ...
                        <div className="mt-3 lg:mt-0 w-full rounded-md bg-[#FFFFFF1A] px-2 py-2">
                          <div className="flex font-[600] justify-between">
                            <div id="token-infos-full" className="flex">
                              {tokenData?.coinData.image_uri && (
                                <Image
                                  src={tokenData?.coinData.image_uri}
                                  width={53.5}
                                  height={53.5}
                                  alt={`${tokenData?.coinData.name} Token Logo`}
                              ...
                              <span className="flex-col leading-none">
                                <span className="flex">
                                  <span className="text-[#FFF] text-sm pl-2">
                                    {tokenData?.coinData.name}
                                  </span>
                                  <span className="text-[#FFFFFF80] text-sm pl-1.5">
                                    [ticker: {tokenData?.coinData.symbol}]
                                  </span>
                                </span>
                                <span className="text-blue text-xs pl-2 font-[400]">
                                  Created by{" "}
                                  {tokenData && (
                                    <>
                                      {tokenData.coinData.username ? (
                                        <>{tokenData.coinData.username}</>
                                      ) : (
                                        <>
                                          {formatAddress(
                                            tokenData.coinData.creator
                                          )}
                                        </>
                                      )}
                                    </>
                                ...
                                <br />
                                <span className="text-green text-xs pl-2 font-[400]">
                                  Market Cap:{" "}
                                  {tokenData && (
                                    <>
                                      {formatMC(tokenData.coinData.market_cap)}
                                    </>
                                  )}
                                </span>
                              </span>
                            ...
                            <div className="flex">
                              <button
                                onClick={() => deleteToken()}
                                id="cancel-btn"
                                className="text-red text-sm flex justify-end mx-1 hover:opacity-80"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 24 24"
                  ...
                  <div id="bump-details">
                    <div className="my-3 w-full rounded-md px-3 py-2.5 bg-[#FFFFFF1A] text-white">
                      ...
                      >
                        <div id="label" className="flex font-[400] sm:w-[35%]">
                          ...
                          <div className="relative">
                            {QModalTokenOpen1 && (
                              <QModal
                                text="Fund your bots with SOL to trade your token. You can withdraw the funds at any time."
                                w={195}
                              />
                            )}
                            <svg
                      ...
                      <div
                        id="duration"
                        className="mt-3 sm:mt-5 sm:flex sm:flex-row sm:row-span-2 sm:items-center"
                      >
                        <div id="label" className="flex font-[400] sm:w-[35%]">
                          <span className="text-[#FFFFFF80] text-xs md:text-sm">
                            Bump for
                          ...
                          <div className="relative">
                            {QModalTokenOpen2 && (
                              <QModal
                                text="Select the duration that you want bots run trades on your token."
                                w={180}
                              />
                            )}
                            <svg
                  ...
                  <div id="pricing" className="w-full px-2 py-1">
                    ...
                    <div
                      id="service"
                      className="flex justify-between mx-auto my-1"
                    >
                      <div className="flex">
                        <span className="text-[#FFF] font-[400] text-sm">
                          Services
                        ...
                        <div className="relative">
                          {QModalTokenOpen4 && (
                            <QModal
                              text="The price of your choosen package per day + 1% of your bots funding."
                              w={160}
                            />
                          )}
                          <svg
                            ...
                            viewBox="0 0 20 20"
                            fill="#FFFFFF80"
                            className="pl-0.5 md:pl-1 w-[15px] h-[15px] md:w-[18px] md:h-[18px] opacity-50 hover:opacity-100 pt-1 md:mt-0 mt-[1.5px]"
                          >
                            <path
                              fillRule="evenodd"
                              d="M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0ZM8.94 6.94a.75.75 0 1 1-1.061-1.061 3 3 0 1 1 2.871 5.026v.345a.75.75 0 0 1-1.5 0v-.5c0-.72.57-1.172 1.081-1.287A1.5 1.5 0 1 0 8.94 6.94ZM10 15a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"
                      ...
                      {Number.isNaN(totalPriceUI) ? null : (
                        <>
                          ...
                          <div className="flex justify-between mx-auto my-1">
                            <div className="flex">
                              <span className="text-[#FFF] font-[600] text-sm">
                                Total:
                              </span>
                            </div>
                            <div className="flex">
              ...
              <div
                id="bump-btn"
                className="lg:my-5 md:my-3 my-2 w-full lg:flex lg:flex-row lg:row-span-2 lg:gap-x-8"
              >
                <div className="w-full hidden lg:block" />
                <div className="w-full">
                  <button
                    disabled={!bumpOk || txSuccess}
                    onClick={() => bump(bumpPackage, tokenFound, duration)}
                    className={`font-[400] text-sm w-full rounded-md px-10 py-2 lg:py-3 ${
                      bumpOk && !txSuccess
      ...
      <>
        {isConnectModalOpen && (
          <>
            <ConnectModal
              showModal={isConnectModalOpen}
              closeModal={handleConnectModal}
              ref={ConnectModalRef}
            />
          </>
        )}
