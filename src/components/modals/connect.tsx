                            ...
                            {listedWallets.map((wallet) => (
                              ...
                              >
                                ...
                                {wallet.adapter.connecting ? (
                                  ...
                                  <>
                                    <span className="font-[400] text-[8px] bg-[#2E303A20] text-[#000] rounded-md px-1.5 py-0.5 mr-1">
                                      Detected
                                    </span>
                                    <svg
                            ...
                            {collapsedWallets.map((wallet) => (
                              ...
                              >
                                <Image
                                  ...
                                  width={27}
                                  height={27}
                                  className="rounded-full p-1 bg-[#2E303A20]"
                                />
                                <span className="pl-1.5">
                                  {wallet.adapter.name}
                                </span>
